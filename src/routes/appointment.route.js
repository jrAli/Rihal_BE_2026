...
import { uploadImage, uploadAttachment  } from '../middlewares/upload.js';
...
appointmentRouter.post('/', authenticate, authorize('CUSTOMER'), uploadImage.single('attachments'), bookAppointment);
